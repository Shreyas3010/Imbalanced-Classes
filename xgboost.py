...
A=[0.1]
results= pd.DataFrame(data=None,index=raw1,columns = ['Thresold', 'Class','Datasize','Training Datasize','Precision','Recall','f1-score','Testing Datasize'])
for i in A:
    b=a
    a=a+1
    results['Thresold'][b]=i
    results['Class'][b]=0
    results['Class'][a]=1
    ...
    model = XGBClassifier(base_score=0.1)
